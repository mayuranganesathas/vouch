...
export interface IntStageFilterVouchProps {
  backgroundColour: "VouchGreen" | "white";
  IntStageDropDownArray: any[];
  value: any;
  onChange: (e) => void;
}

export const IntStageFilterVouch: React.FC<IntStageFilterVouchProps> = ({
  backgroundColour,
  IntStageDropDownArray,
  value,
  onChange,
}) => {
  ...
  return (
    <form>
      ...
      >
        ...
        {IntStageDropDownArray &&
          IntStageDropDownArray.filter((v, i, a) => a.indexOf(v) === i)
            .filter((ele) => ele != "")
