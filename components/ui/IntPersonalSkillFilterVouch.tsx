...
export interface IntPersonalSkillFilterVouchProps {
  backgroundColour: "VouchGreen" | "white";
  IntPersonalSkillDropDownArray: any[];
  value: any;
  onChange: (e) => void;
}

export const IntPersonalSkillFilterVouch: React.FC<IntPersonalSkillFilterVouchProps> = ({
  backgroundColour,
  ...
  return (
    <form>
      ...
      >
        ...
        {IntPersonalSkillDropDownArray &&
          IntPersonalSkillDropDownArray.filter((v, i, a) => a.indexOf(v) === i)
            .filter((ele) => ele != "")
